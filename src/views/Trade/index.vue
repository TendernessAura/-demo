  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="index"
        @click="changeDefault(info, addressInfo)"
      >
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="order.imgUrl" style="width: 100px" />
          </li>
          <li>
            <p>
              {{ order.skuName }}
...
export default {
  ...
  methods: {
    changeDefault(info, addressInfo) {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.userDefaultAddress.consignee || "张三",
        consigneeTel: this.userDefaultAddress.phoneNum || "13700000000",
        deliveryAddress: this.userDefaultAddress.fullAddress || "成都",
        paymentWay: "ONLINE",
